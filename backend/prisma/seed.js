...
const menuItems = [
  ...
  { 
    ...
    price: 220, 
    description: 'Smoky marinated cottage cheese, grilled to perfection', 
    tags: ['spicy', 'veg', 'bestseller'], 
    allergens: ['dairy'], 
    popularScore: 0.9, 
  ...
  { 
    ...
    category: 'Veg Starters', 
    price: 160, 
    description: 'Crunchy sweet corn tossed with spices', 
    tags: ['light', 'veg', 'quick-serve'], 
    allergens: [], 
    popularScore: 0.75, 
  ...
  { 
    ...
    category: 'Veg Starters', 
    price: 180, 
    description: 'Spinach and peas patties, lightly spiced', 
    tags: ['light', 'veg'], 
    allergens: ['gluten'], 
    popularScore: 0.65, 
  ...
  { 
    ...
    category: 'Veg Starters', 
    price: 200, 
    description: 'Deep fried mushrooms with South Indian spices', 
    tags: ['spicy', 'veg'], 
    allergens: [], 
    popularScore: 0.7, 
  ...
  { 
    ...
    price: 220, 
    description: 'Crispy chicken tossed in fiery Indo-Chinese sauce', 
  ...
  { 
    ...
    category: 'Non-Veg Starters', 
    price: 280, 
    description: 'South-style prawns with bold black pepper spice', 
    tags: ['spicy'], 
    allergens: ['shellfish'], 
    popularScore: 0.8, 
  ...
  { 
    ...
    category: 'Non-Veg Starters', 
    price: 260, 
    description: 'Light marinade, smoky char-grilled fish', 
    tags: ['light'], 
    allergens: ['fish'], 
    popularScore: 0.78, 
  ...
  { 
    ...
    category: 'Mains (Veg)', 
    price: 280, 
    description: 'Rich tomato-butter gravy with soft paneer', 
    tags: ['filling', 'veg', 'bestseller'], 
    allergens: ['dairy'], 
    popularScore: 0.95, 
  ...
  { 
    ...
    category: 'Mains (Veg)', 
    price: 240, 
    description: 'Fiery Maharashtrian mixed vegetable curry', 
    tags: ['spicy', 'veg'], 
    allergens: [], 
    popularScore: 0.7, 
  ...
  { 
    ...
    price: 320, 
    description: 'Classic mildly spiced chicken in buttery tomato gravy', 
    tags: ['filling', 'bestseller'], 
    allergens: ['dairy'], 
    popularScore: 0.97, 
  ...
  { 
    ...
    category: 'Mains (Non-Veg)', 
    price: 380, 
    description: 'Kashmiri slow-cooked mutton with aromatic spices', 
    tags: ['spicy', 'filling'], 
    allergens: [], 
    popularScore: 0.85, 
  ...
  { 
    ...
    category: 'Mains (Non-Veg)', 
    price: 360, 
    description: 'Coastal-style prawns in tangy masala gravy', 
    tags: ['spicy'], 
    allergens: ['shellfish'], 
    popularScore: 0.78, 
    imageUrl: 'https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=400&q=80' 
  ...
  { 
    ...
    tags: ['filling', 'bestseller', 'chef_special'], 
    allergens: [], 
    popularScore: 0.96, 
  ...
  { 
    ...
    category: 'Breads & Rice', 
    price: 80, 
    description: 'Plain basmati rice, light and fluffy', 
    tags: ['veg', 'light'], 
    allergens: [], 
    popularScore: 0.7, 
  ...
  { 
    ...
    category: 'Desserts', 
    price: 120, 
    description: 'Soft paneer discs in chilled saffron milk', 
    tags: ['sweet', 'veg'], 
  ...
  { 
    ...
    category: 'Desserts', 
    price: 130, 
    description: 'Traditional Indian ice cream with rose falooda', 
    tags: ['sweet', 'veg'], 
    allergens: ['dairy', 'nuts'], 
    popularScore: 0.82, 
  ...
  { 
    ...
    category: 'Beverages (Hot)', 
    price: 70, 
    description: 'South Indian strong decoction with frothy milk', 
  ...
  { 
    ...
    category: 'Beverages (Hot)', 
    price: 120, 
    description: 'Rich Belgian chocolate drink topped with cream', 
    tags: ['sweet'], 
    allergens: ['dairy'], 
    popularScore: 0.75, 
  ...
  { 
    ...
    price: 100, 
    description: 'Thick chilled yogurt blended with Alphonso mango', 
    tags: ['sweet', 'veg', 'bestseller'], 
    allergens: ['dairy'], 
    popularScore: 0.92, 
  ...
  { 
    ...
    category: 'Beverages (Cold)', 
    price: 70, 
    description: 'Zesty lime with sparkling water, sweet or salted', 
    tags: ['light', 'veg', 'quick-serve'], 
    allergens: [], 
    popularScore: 0.85, 
  ...
  { 
    ...
    category: 'Beverages (Cold)', 
    price: 90, 
    description: 'Fresh-pressed watermelon, chilled and refreshing', 
    tags: ['light', 'veg'], 
    allergens: [], 
    popularScore: 0.75, 
    imageUrl: 'https://images.unsplash.com/photo-1568909344668-6f14a07b56a0?w=400&q=80' 
  },
  // Combos
  { 
    name: 'Veg Thali', 
    ...
    price: 350, 
    description: '2 sabzis + dal + rice + 2 rotis + dessert', 
  ...
  { 
    ...
    category: 'Combos & Deals', 
    price: 450, 
    description: 'Chicken curry + dal + rice + 2 naans + raita', 
    tags: ['filling', 'bestseller', 'shareable'], 
    allergens: ['dairy', 'gluten'], 
    popularScore: 0.92, 
    imageUrl: 'https://images.unsplash.com/photo-1546833999-b9f581a1996d?w=400&q=80' 
  },
  { 
    name: 'Starter Platter (Veg)', 
    category: 'Combos & Deals', 
    price: 480, 
    description: 'Paneer Tikka + Crispy Corn + Hara Bhara Kabab', 
    tags: ['veg', 'shareable'], 
    allergens: ['dairy', 'gluten'], 
    popularScore: 0.85, 
    imageUrl: 'https://images.unsplash.com/photo-1567188040759-fb8a883dc6d8?w=400&q=80' 
  ...
  { 
    name: 'Starter Platter (Non-Veg)', 
    category: 'Combos & Deals', 
    price: 560, 
    description: 'Chilli Chicken + Seekh Kabab + Fish Tikka', 
    tags: ['shareable', 'bestseller'], 
